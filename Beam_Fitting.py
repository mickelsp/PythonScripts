...
inputFileName = 'NdYAG10Hz_BeamProfile_20140313_BeamSize.txt'
...
plsq = optimize.leastsq(residuals,[waistGuess,zGuess],args = (beamSize-0.00145,zData))
...
beamPropagate = GaussianPropagate(zFit,[fitWaist,fitWaistPosition])+0.00145
