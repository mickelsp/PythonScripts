...
if shortcut1090 == 1:
	...
	plt.title('Beam Sizes of NdYAG Laser')
	
elif shortcut1090 == 0:
	## Analyze full knife edge data set
	measurementposition = [19.5] #[cm] Position relative to beam's zero point
	directoryname = '/Users/mickelsp/Documents/YAG Beam Profile/'
	filenames = ['NdYAG10Hz_BeamProfile_20140313_Full.txt']
	...
	for i in range(numfiles):
		...
		ydata = np.abs(np.array(ydata)-140)
